...
namespace Sitecore.Reference.Storefront.Managers
{
    ...
    using System.Linq;
    using System.Web;
    using Commerce.Connect.DynamicsRetail.Services.Payments;
    ...
    public class PaymentManager : BaseManager
    {
        ...
        public ManagerResponse<GetPaymentServiceUrlResult, string> GetPaymentServiceUrl()
        {
        ...
        public ManagerResponse<GetPaymentServiceTokenizedResult, string> GetPaymentServiceActionResult(string accessCode)
        {
            ...
            var result = this.PaymentServiceProvider.RunPipeline<GetPaymentServiceActionResultRequest, GetPaymentServiceTokenizedResult>(Commerce.Pipelines.PipelineName.GetPaymentServiceActionResult, request);
