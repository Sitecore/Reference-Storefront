...
namespace Sitecore.Reference.Storefront
{
    ...
    public static class RouteConfig
    {
        private static List<ApiInfo> _apiInfoList = new List<ApiInfo>()
        {
            ...
            new ApiInfo("checkout-getcardpaymentaccepturl", "Checkout", "GetCardPaymentAcceptUrl"),
        ...
        public static void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapRoute(
               ...
               url: "oauthv2redirect",
               defaults: new { controller = "Account", action = "OAuthV2Redirect", userName = UrlParameter.Optional, siteName = UrlParameter.Optional }
            );

            routes.MapRoute(
               name: "acsredirect",
               url: "acsredirect",
               defaults: new { controller = "Account", action = "AcsRedirect", userName = UrlParameter.Optional, siteName = UrlParameter.Optional }
            );
        }
    }
}