...
namespace Sitecore.Reference.Storefront.Controllers
{
    ...
    public class CatalogController : AXBaseController
    {
        #region Variables
        ...
        public JsonResult SignUpForBackInStockNotification(SignUpForNotificationInputModel model)
        {
            ...
            {
                CommerceLog.Current.Error("SignUpForBackInStockNotification", this, e);
                return Json(new BaseJsonResult("SignUpForBackInStockNotification", e), JsonRequestBehavior.AllowGet);
            }
        }
        ...
        protected void PopulateStockInformation(ProductViewModel model)
        {
            ...
            var response = this.InventoryManager.GetStockInformation(
                this.CurrentStorefront,
                new List<CommerceInventoryProduct> { new CommerceInventoryProduct { ProductId = model.ProductId, CatalogName = model.CatalogName } },
