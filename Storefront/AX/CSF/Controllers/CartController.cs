...
namespace Sitecore.Reference.Storefront.Controllers
{
    ...
    /// </summary>
    public class CartController : AXBaseController
    {
        #region Properties
        ...
        /// <summary>
        /// The action for rendering the Mini cart view.
        /// </summary>
        /// <returns>The MiniCart view.</returns>
        ...
        /// <returns>
        /// Returns json result with add item to cart operation status
        /// </returns>
        [AllowAnonymous]
        [HttpPost]
